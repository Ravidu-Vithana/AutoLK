...
public class SignUp extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (user_DTO.getFirst_name().isEmpty()) {
            ...
            response_DTO.setContent("Please enter your Mobile");
        } else if (!Validations.isInteger(user_DTO.getMobile())) {
            response_DTO.setContent("Please enter a valid Mobile");
        } else if (!Validations.isMobileNumberValid(user_DTO.getMobile())) {
            response_DTO.setContent("Please enter a valid Mobile in format 07XXXXXXXX");
            ...
            if (!criteria1.list().isEmpty()) {
                ...
                Thread sendMailThread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        Mail.sendMail(
                                user_DTO.getEmail(),
                                "Verification for AutoLK Registration",
                                "<h1 style=\"color:#6482AD;\">Your verification code is " + code + "</h1>"
                        );
                    }
                });
